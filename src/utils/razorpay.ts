...
export async function openRazorpay(resourceType: 'course' | 'testseries' | 'book', resource: any) {
  ...
  if (resourceType === 'testseries') payload.testSeriesId = id;
