        ...
        <div className="flex flex-col lg:flex-row items-center gap-12">
          <div className="flex-1 text-center lg:text-left">
            <div className="inline-flex items-center gap-2 bg-primary/10 text-primary px-4 py-2 rounded-full text-sm font-medium mb-6 animate-fade-in">
              ...
              <span>6 Times AIR 1 | Trusted by 200K+ Students</span>
            </div>
            ...
            {/* Quick Stats */}
            <div className="flex flex-wrap justify-center lg:justify-start gap-8 mt-10 animate-fade-in" style={{ animationDelay: "0.4s" }}>
              <div className="text-center">
                <p className="text-2xl md:text-3xl font-bold text-primary">52K+</p>
                <p className="text-sm text-muted-foreground">Students Cleared</p>
              </div>
              <div className="text-center">
                <p className="text-2xl md:text-3xl font-bold text-primary">430+</p>
                <p className="text-sm text-muted-foreground">AIR Holders</p>
              </div>
              <div className="text-center">
